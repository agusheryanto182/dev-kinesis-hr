                    ...
                    <div className="space-y-3">
                        ...
                        <div className="flex items-center space-x-3">
                            ...
                            <div>
                                ...
                                <p className="text-sm text-gray-600 mt-1">{EmploymentTypeBadge({ employmentType: job.employmentType })}</p>
                            </div>
                        </div>
                        ...
                        <div className="flex items-center space-x-3">
                            ...
                            <div>
                                ...
                                <p className="text-sm text-gray-600">{formatSalary(job.salaryMin, job.salaryMax, job.currency, job.salaryType)}</p>
                            </div>
                        </div>
