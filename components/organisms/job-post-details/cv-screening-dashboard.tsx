...
const jobPost = {
  ...
  description:
    'We are looking for an experienced Golang developer to join our backend team. You will be responsible for building scalable microservices and APIs.',
  requirements: [
...
const mockCandidates = [
  {
    ...
    summary:
      'Senior backend developer with 5 years of Go experience, specializing in microservices architecture.',
  ...
  },
  {
    ...
    summary:
      'Expert Go developer with extensive experience in distributed systems and cloud infrastructure.',
  ...
  },
  {
    ...
    summary:
      'Mid-level developer with solid Go foundation and growing expertise in containerization.',
  ...
  },
  {
    ...
    summary:
      'Senior engineer with deep expertise in Go, cloud-native technologies, and infrastructure as code.',
  ...
  },
  {
    ...
    summary:
      'Experienced Go developer with strong background in message queues and caching systems.',
