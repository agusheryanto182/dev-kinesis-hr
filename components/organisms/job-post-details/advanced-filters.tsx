...
const allSkills = [
    'golang', 'microservices', 'docker', 'kubernetes', 'postgresql',
    'grpc', 'rest-api', 'aws', 'gcp', 'azure', 'redis', 'mongodb',
    'rabbitmq', 'kafka', 'prometheus', 'grafana', 'terraform', 'jenkins'
];
...
const predefinedFilterOptions = {
    ...
    languages: ['Indonesian', 'English', 'Mandarin', 'Arabic', 'Hindi', 'Tamil', 'Japanese', 'Korean']
};
...
export function AdvancedFilters({ filters, onFiltersChange, jobRequiredSkills }: AdvancedFiltersProps) {
            ...
            <CardContent className="space-y-6">
                ...
                <div className="space-y-4">
                    ...
                    <div className="space-y-3">
                        <label className="text-xs font-medium text-gray-600 uppercase tracking-wide">Custom Key-Value</label>
                        <div className="flex space-x-2">
                            <Input
                        ...
                        <p className="text-xs text-gray-500">
                            Create custom filters like &quot;agama: islam&quot;, &quot;hobi: fotografi&quot;, &quot;asal kota: bandung&quot;
                        </p>
                    </div>
                    ...
                    {Object.keys(filters.customFilters).length > 0 && (
                        <div className="space-y-2">
                            <label className="text-xs font-medium text-gray-600 uppercase tracking-wide">Active Custom Filters</label>
                            <div className="space-y-2">
                ...
                <div className="space-y-2">
                    ...
                    <div className="flex flex-wrap gap-2">
                        ...
                        <Button
                            ...
                            size="sm"
                            onClick={() => {
                                updateFilter('customFilters', { ...filters.customFilters, nationality: 'indonesia' });
                            }}
                        >
                            Indonesian Only
                        </Button>
