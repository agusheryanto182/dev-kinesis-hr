...
import { MoreHorizontal, Download, ChevronLeft, ChevronRight, Eye, Star, MapPin, TrendingUp } from 'lucide-react';
                                ...
                                >
                                    ...
                                    <TableCell>
                                        <div className="space-y-2">
                                            <div className="flex items-center space-x-2">
                                                <Badge
                                                    variant="secondary"
                                                    className={`text-xs ${skillsMatch.percentage >= 80 ? 'bg-green-100 text-green-800' :
                                                        skillsMatch.percentage >= 60 ? 'bg-yellow-100 text-yellow-800' :
                                    ...
                                    <TableCell>
                                        <div className="space-y-1">
                                            ...
                                            <p className="text-sm font-medium text-green-600">{formatSalary(candidate.expectedSalary)}</p>
                                        </div>
                                    </TableCell>
